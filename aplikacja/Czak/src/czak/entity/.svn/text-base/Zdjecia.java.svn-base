...
@Entity
@Table(name = "Zdjecia")
@NamedQueries({@NamedQuery(name = "Zdjecia.findAll", query = "SELECT z FROM Zdjecia z"), @NamedQuery(name = "Zdjecia.findByIdZdjecia", query = "SELECT z FROM Zdjecia z WHERE z.idZdjecia = :idZdjecia"), @NamedQuery(name = "Zdjecia.findByNrZdjecia", query = "SELECT z FROM Zdjecia z WHERE z.nrZdjecia = :nrZdjecia"), @NamedQuery(name = "Zdjecia.findByPlik", query = "SELECT z FROM Zdjecia z WHERE z.plik = :plik")})
public class Zdjecia implements Serializable {
    ...
    public Zdjecia(Integer idZdjecia, int nrZdjecia, String plik) {
        this.idZdjecia = idZdjecia;
    ...
    public String toString() {
        return "czakhiber.entity.Zdjecia[idZdjecia=" + idZdjecia + "]";
    }
